      ...
      <div className="section justify-between">
        ...
        <div className="flex flex-col justify-center w-full px-2 xs: sm:px-12 md:px-4 lg:px-14 text-white ">
          ...
          <div className="text-gray-400 py-4 space-y-2 md:space-y-2 md:pt-8 lg:pt-12 font-semibold text-justify">
            <AnimatedWrapper>
              <p className="leading-tight">
                Full-Stack Web Developer passionate about building modern and responsive web applications.
              </p>
            </AnimatedWrapper>
            <AnimatedWrapper>
              <p className="leading-tight">
                Skilled in HTML, CSS, JavaScript, TypeScript, React, Tailwind CSS, PHP, Laravel, SQL, and MySQL.
              </p>
            </AnimatedWrapper>
            <AnimatedWrapper>
              <p className="leading-tight">
                Focused on writing clean, scalable code and continuously improving my front-end and back-end<br className="hidden lg:block"/> development skills.
              </p>
            </AnimatedWrapper>
          </div>
          <AnimatedWrapper>
          ...
          <AnimatedWrapper>
            <div className="py-5">
              <a
                href={NoorulhaqRahimiCV}
                target="_blank"
                rel="noreferrer"
                download={true}
                className="z-30  group bg-gradient-to-br from-cyan-400 to-blue-600 flex items-center justify-center gap-3 px-6 py-3  rounded-lg ease-linear duration-300 delay-75 transition-all cursor-pointer w-48 relative"
              >
