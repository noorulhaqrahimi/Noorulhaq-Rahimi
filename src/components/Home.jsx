...
import NR from '../assets/Favicons/NR.png'
...
const Home = () => {
  ...
  return (
    <div
      name="Home"
      className=" h-full min-h-screen w-full flex items-center bg-gradient-to-b from-black via-black to-gray-800 "
    >
      <div className="section gap-16 md:gap-1 md:justify-between items-center md:flex-row-reverse">
        ...
        <div className="pl-2 xs:pl-8 flex flex-col gap-3 justify-center text-gray-200 w-max md:w-3/5">
          <AnimatedWrapper delay={0.2}>
            <h1 className="text-3xl xs:text-6xl lg:text-5xl font-bold ">
